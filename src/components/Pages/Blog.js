...
const Blog = () => {
    return (
        ...
        <div className='row'>
            <h3 style={{color:'purple'}} className='mt-5 border-bottom'>JavaScript, NodeJs and Mongodb Blog</h3>
            <div className='col-12 col-sm-12 col-md-6 col-lg-6 mt-5'>
                <h4 style={{color:'purple'}}>Q. 1. Difference between javascript and nodejs</h4>
                <p>Ans.- </p>
                <ol>
            ...
            <div className='col-12 col-sm-12 col-md-6 col-lg-6 mt-5'>
            <h4 style={{color:'purple'}}>Q. 2. When should you use NodeJs and when should you use MongoDb?</h4>
                <p>Ans.- </p>
            ...
            <h4 style={{color:'purple'}}>Q. 3. Differences between SQL and NOSQL databases.</h4>
                <p>Ans.- </p>
            ...
            <div className='col-12 col-sm-12 col-md-6 col-lg-6 mt-5 mb=5'>
            <h4 style={{color:'purple'}}>Q. 4. What is the purpose of JWT and how does it work?</h4>
                <p>Ans.- </p>
