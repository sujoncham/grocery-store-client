...
const Blog = () => {
    return (
        ...
        <div className='row'>
            <h1 style={{color:'purple'}} className='mt-5 border-bottom'>JavaScript, NodeJs and Mongodb Blog</h1>
            <div className='col-12 col-sm-12 col-md-6 col-lg-6 mt-5'>
                <h3 style={{color:'purple'}}>Q. 1. Difference between javascript and nodejs</h3>
                <p>Ans.- </p>
                <ol>
            ...
            <div className='col-12 col-sm-12 col-md-6 col-lg-6 mt-5'>
            <h3 style={{color:'purple'}}>Q. 2. When should you use `nodejs` and when should you use `mongodb`</h3>
                <p>Ans.- </p>
            ...
            <h3 style={{color:'purple'}}>Q. 3. Differences between `sql` and `nosql` databases.</h3>
                <p>Ans.- </p>
            ...
            <div className='col-12 col-sm-12 col-md-6 col-lg-6 mt-5 mb=5'>
            <h3 style={{color:'purple'}}>Q. 4. What is the purpose of `jwt` and how does it work</h3>
                <p>Ans.- </p>
